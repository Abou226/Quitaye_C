...
namespace Quitaye.Controls
{
    public class CircleProgress : SKCanvasView
    {
        ...
        public static readonly BindableProperty ProgressStartColorProperty =
            BindableProperty.Create(nameof(ProgressStartColor), typeof(Color), typeof(CircleProgress), Color.Blue, propertyChanged: OnPropertyChanged);

        public static readonly BindableProperty ProgressEndColorProperty =
            BindableProperty.Create(nameof(ProgressEndColor), typeof(Color), typeof(CircleProgress), Color.Red, propertyChanged: OnPropertyChanged);
