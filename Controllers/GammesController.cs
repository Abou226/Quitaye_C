...
namespace Controllers
{
    ...
    public class GammesController : GenericController<Gamme, User, Marque, Style, Categorie>
    {
        ...
        public override async Task<ActionResult<Gamme>> PatchUpdateAsync([FromBody] JsonPatchDocument value, [FromRoute] Guid id)
        {
            try
            {
        ...
        public async Task<ActionResult<Gamme>> ChangeEntrepriseUpdateAsync([FromBody] JsonPatchDocument value, [FromRoute] Guid entreprise)
        {
            try
            {
        ...
        public override async Task<ActionResult<IEnumerable<Gamme>>> AddAsync([FromForm] Gamme value)
        {
            try
            {
                if (value == null)
        ...
        [Authorize]
        public async Task<ActionResult<IEnumerable<Gamme>>> GetBy([FromRoute] DateTime start, DateTime end)
        {
            try
            {
                var claim = (((ClaimsIdentity)User.Identity).Claims.FirstOrDefault(x => x.Type == "Id").Value);
