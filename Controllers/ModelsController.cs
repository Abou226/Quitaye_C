...
namespace Controllers
{
    ...
    public class ModelsController : GenericController<Model, User>
    {
        ...
        [HttpDelete("{id}")]
        public override async Task<ActionResult<Model>> Delete([FromRoute] Guid id)
        {
            try
            {
        ...
        public override async Task<ActionResult<Model>> PatchUpdateAsync([FromBody] JsonPatchDocument value, [FromRoute] Guid id)
        {
            try
            {
        ...
        public async Task<ActionResult<Model>> ChangeEntrepriseUpdateAsync([FromBody] JsonPatchDocument value, [FromRoute] Guid entreprise)
        {
            try
            {
