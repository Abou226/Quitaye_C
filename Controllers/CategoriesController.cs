namespace Controllers
{
    ...
    public class CategoriesController : GenericController<Categorie, User>
    {
        ...
        public async Task<ActionResult<Categorie>> ChangeEntrepriseUpdateAsync([FromBody] JsonPatchDocument value, [FromRoute] Guid entreprise)
        {
            try
            {
        ...
        public override async Task<ActionResult<Categorie>> PatchUpdateAsync([FromBody] JsonPatchDocument value, [FromRoute] Guid id)
        {
            try
            {
