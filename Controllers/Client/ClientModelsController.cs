...
namespace Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class ClientModelsController : GenericController<Model, Client>
    {
        private readonly IGenericRepositoryWrapper<Model, Client> repositoryWrapper;
        private readonly IConfigSettings _settings;
        private readonly IMapper _mapper;
        private readonly IGenericRepositoryWrapper<EntrepriseUser> _entrepriseUser;

        public ClientModelsController(IGenericRepositoryWrapper<Model, Client> wrapper,
