...
namespace Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class ClientMarquesController : GenericController<Marque, Client>
    {
        private readonly IGenericRepositoryWrapper<Marque, Client> repositoryWrapper;
        private readonly IConfigSettings _settings;
        private readonly IMapper _mapper;
        private readonly IGenericRepositoryWrapper<EntrepriseUser> _entrepriseUser;
        private readonly IFileManager _fileManager;

        public ClientMarquesController(IGenericRepositoryWrapper<Marque, Client> wrapper,
